This boilerplate README was generated by create-react-app. To see the README for the hvac-monitor application,
head over to the server repository at [hvac-monitor-server](https://github.com/markgreenwood/hvac-monitor-server).
